...
function hexToUint8Array(hex) {
  ...
  const bytes2 = new Uint8Array(Math.ceil(value.length / 2));
...
var toChecksumAddress = (address) => {
  ...
  const hash2 = utils_exports.uint8ArrayToHexString(keccak256(utf8ToBytes2(lowerCaseAddress)));
...
var sha3 = (data) => {
  ...
  const hash2 = bytesToHex2(keccak256(updatedData));
...
var metamaskPayload = (payload) => {
  ...
  if (Array.isArray(payload.params)) {
    ...
    if (params.input && !params.data) {
      return Object.assign(Object.assign({}, payload), { params: [Object.assign(Object.assign({}, params), { data: (_a4 = params.data) !== null && _a4 !== void 0 ? _a4 : params.input })] });
    }
  }
  return payload;
};
...
var getAccounts2 = (requestManager) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_listAccounts",
    params: []
  });
});
var newAccount = (requestManager, password) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_newAccount",
    params: [password]
  });
});
var unlockAccount = (requestManager, address, password, unlockDuration) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_unlockAccount",
    params: [address, password, unlockDuration]
  });
});
var lockAccount = (requestManager, address) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_lockAccount",
    params: [address]
  });
});
var importRawKey = (requestManager, keyData, passphrase) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_importRawKey",
    params: [keyData, passphrase]
  });
});
var sendTransaction2 = (requestManager, tx, passphrase) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_sendTransaction",
    params: [tx, passphrase]
  });
});
var signTransaction2 = (requestManager, tx, passphrase) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_signTransaction",
    params: [tx, passphrase]
  });
});
var sign2 = (requestManager, data, address, passphrase) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
    method: "personal_sign",
    params: [data, address, passphrase]
  });
});
var ecRecover = (requestManager, signedData, signature) => __awaiter16(void 0, void 0, void 0, function* () {
  return requestManager.send({
...
var Wallet = class _Wallet extends Web3BaseWallet {
  ...
  encrypt(password, options) {
    return __awaiter17(this, void 0, void 0, function* () {
      return Promise.all(this.map((account) => __awaiter17(this, void 0, void 0, function* () {
  ...
  decrypt(encryptedWallets, password, options) {
    return __awaiter17(this, void 0, void 0, function* () {
      const results = yield Promise.all(encryptedWallets.map((wallet) => __awaiter17(this, void 0, void 0, function* () {
...
var signTransaction3 = (transaction, privateKey) => __awaiter18(void 0, void 0, void 0, function* () {
...
var encrypt2 = (privateKey, password, options) => __awaiter18(void 0, void 0, void 0, function* () {
...
var privateKeyToAccount = (privateKey, ignoreLength) => {
  ...
  return {
    ...
    encrypt: (password, options) => __awaiter18(void 0, void 0, void 0, function* () {
...
var decrypt2 = (keystore, password, nonStrict) => __awaiter18(void 0, void 0, void 0, function* () {
...
var encodeFunctionCall = (jsonInterface, params) => {
  ...
  return `${encodeFunctionSignature(jsonInterface)}${encodeParameters2((_a4 = jsonInterface.inputs) !== null && _a4 !== void 0 ? _a4 : [], params !== null && params !== void 0 ? params : []).replace("0x", "")}`;
};
